...
--Criando tabelas Cidade e Empregado
...
Values
('Carla Rodrigues','09-09-2024',1500.00),
('Roberto Silva','10-09-2024',1700.00),
('Samara Santos','12-09-2024',2000.00),
('Cleber Araujo','12-09-2024',1800.00),
('Carlos Lima','13/09/2024',3500.00)

--Select Distinct : seleciona campos não repetidos  
...
--Select Faixa de valores (Between)

--Salario entre 1500 e 2000
 select * from Empregado
 where Salario between 1500 and 2000

 --Valor unitario 0.32 ate 2.00

 select cod_produto, descricao
 from produto
 where Valor_unitario between 0.32 and 2.00

 -- Select Comparando Cadeia de Caracter (LIKE ou NOT LiKE %)

 -- contenha M no meio da palavra
 select * from Empregado
 where Nome like '%M%'

 -- contenha C no começo
 ...
 -- salario maior que 1000 e matricula  >= 3

 select * from Empregado
 where Salario > 1000 and Nrmatricula >=3

  select * from Empregado
 where Salario > 1000 or Nrmatricula >=4
 ...
 --Ordem alfabética pelo campo nome_vendedor
